...
class CPL_Admin_Widgets_Hms_PatientVisitSummary_Model extends CP_Common_Lib_WidgetModelAbstract
{
    ...
    function setSearchVar() {
        ...
        $site_id        = $fn->getReqParam('site_id');
         $patientVist = $fn->getReqParam('patientVist');

        $previousDate       = date("Y-m-d", strtotime("yesterday"));


            if ($patientVist == "Yesterday") {
    ...
    function getExportToExcel(){
        ...
        $file_name = "PatientVisitSummary_" . date("d-m-Y") . ".xls";
        ...
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'Doctor Morning');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'Doctor Evening');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'Doctor Total');
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $morningVisits);
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $evengVisits);
