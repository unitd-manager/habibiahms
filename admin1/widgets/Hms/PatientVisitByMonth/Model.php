<?
class CPL_Admin_Widgets_Hms_PatientVisitByMonth_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar() {
        ...
        $searchVar->groupBy   = "pi.address_area, DATE_FORMAT(pv.check_up_date, '%Y-%m')";
        $searchVar->sortOrder = "COUNT(pv.patient_visit_id) DESC";
        //$searchVar->sortOrder = "pi.address_area";
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'hms_patientVisitByMonth');
