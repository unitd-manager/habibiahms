...
class CPL_Admin_Modules_Tradingin_Inventory_Controller extends CP_Admin_Modules_Tradingin_Inventory_Controller
{
   ...
   function getPrintConsultantMedicine() {
        return $this->view->getPrintConsultantMedicine();
    }

    function getUpdateMedPurchasedQty() {
        return $this->model->getUpdateMedPurchasedQty();
    }

    function getFlagUnflagAllRecords() {
        return $this->model->getFlagUnflagAllRecords();
    }

    function getFlagRecordByID() {
        return $this->model->getFlagRecordByID();
    }

    function getUpdateExpectedQty() {
        return $this->model->getUpdateExpectedQty();
    }
}