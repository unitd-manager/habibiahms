<?
class CPL_Admin_Modules_Tradingsg_PurchaseOrder_Functions
{
    /**
     *
     */
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('tradingsg_purchaseOrder', 'picture', 'image');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('tradingsg_purchaseOrder', 'tradingsg_po_productLink');
