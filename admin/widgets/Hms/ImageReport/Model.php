<?
class CPL_Admin_Widgets_Hms_ImageReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getSqlForCount() {
        ...
        foreach($this->dataArray as $row){
            ...
            $totalPatTestXrayAmount = 0;
            $totalPatTestEcgCount   = 0;
            $totalPatTestEegCount   = 0;
            $totalPatTestEcgAmount  = 0;
            $totalPatTestEegAmount  = 0;
            ...
            while ($rowPatLabTest = $db->sql_fetchrow($resultPatLabTest)) {
                ...
                if($rowPatLabTest['category_title'] == "E.E.G"){
                    $totalPatTestEegCount  += $rowPatLabTest['count'];
                    $totalPatTestEegAmount += $fees;
                }
            ...
            while ($rowLabTest    = $db->sql_fetchrow($resultLabTest)) {
                ...
                if($rowLabTest['category_title'] == "E.E.G"){
                    $totalTestEegCount  += $rowLabTest['count'];
                    $totalTestEegAmount += $fees;
                }
            ...
            $totalIpTestXrayAmount = 0;
            $totalIpTestEcgCount   = 0;
            $totalIpTestEegCount   = 0;
            $totalIpTestEcgAmount  = 0;
            $totalIpTestEegAmount  = 0;
            ...
            while ($rowInPatLabTest    = $db->sql_fetchrow($resultInPatLabTest)) {
                ...
                if($rowInPatLabTest['category_title'] == "E.E.G"){
                    $totalIpTestEegCount  += $rowInPatLabTest['count'];
                    $totalIpTestEegAmount += $fees;
                }
            ...
            $totalAlltestcount  = $totaltestcount + $totalPattestcount + $totalIpTestCount + $totalPatTestXrayCount + $totalPatTestEcgCount + $totalTestXrayCount + $totalTestEcgCount + $totalTestEegCount + $totalIpTestXrayCount + $totalIpTestEcgCount;
            $totalAlltestamount = $totaltestamount + $totalPattestamount + $totalIpTestAmount + $totalPatTestXrayAmount + $totalPatTestEcgAmount + $totalTestXrayAmount + $totalTestEcgAmount + $totalTestEegCount + $totalIpTestXrayAmount + $totalIpTestEcgAmount;
            ...
            $totalEegCount   += $totalPatTestEegCount + $totalTestEegCount + $totalIpTestEegCount;
            ...
            $totalEegAmount  += $totalPatTestEegAmount + $totalTestEegAmount + $totalIpTestEegAmount;
        }       
        ...
        <tr>
            ...
            <th width='26%' style='border-top:1px solid #FFFFFF;line-height:25px;'>E.E.G: {$totalEegCount} / {$totalEegAmount}RS</th>
