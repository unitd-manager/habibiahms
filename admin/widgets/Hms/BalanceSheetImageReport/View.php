<?
class CPL_Admin_Widgets_Hms_BalanceSheetImageReport_View extends CP_Common_Lib_WidgetViewAbstract
{
    //==================================================================//
    function getWidget() {
        ...
        $text = "
        <div class='float_left mr20'><h2>Balance Sheet Image Report</h2></div>
    ...
    function getRowsHTML() {
        ...
        <tr>
            <td class='incomeReport' width='30%'>
                <table width=100%>
                    <tr>
                        <td width = '70%'><span>Image Test</span></td>
