<?
class CPL_Admin_Modules_Hms_MedicalTest_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar($linkRecType = '') {
       ...
       // $company_name = $fn->getReqParam('company_name');
        ...
        if ($medical_test_id != "") {
            ...
            if ($category != "") {
                $searchVar->sqlSearchVar[] = "mt.category = '{$category}'";
            }else{
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'lab_supplier_fees');
        $fa = $fn->addToFieldsArray($fa, 'container');
