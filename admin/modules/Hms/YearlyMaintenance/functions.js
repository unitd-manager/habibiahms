Util.createCPObject('cpm.hms.yearlyMaintenance');

cpm.hms.yearlyMaintenance = {
    init: function(){
        ...
        var expObj = {
           ...
           ,callbackOnSuccess: function(json){
                ...
                cpm.hms.yearlyMaintenance.refreshValueListOptions(valuelist_name, field_name, selectedValue);
            }
        }
        ...
        $('.editSelectedValue').livequery('click', function (e){
            ...
            var url = 'index.php?module=hms_yearlyMaintenance&_spAction=editValuelistForm&showHTML=0&valuelist_id=' + selectedId + '&valuelist_name=' + encodeURIComponent(valuelist_name);
            var $tempLink = $('<a/>');
            ...
            Util.openFormInDialog.call($tempLink, 'portalForm', title, 400, 300, {
                ...
                callbackOnSuccess: function(){
                    Util.closeAllDialogs();
                    cpm.hms.yearlyMaintenance.refreshCategoryOptions(valuelist_name, selectedId);
                }
            });
        });
        ...
        $('.deleteSelectedValue').livequery('click', function (e){
            ...
            var url = 'index.php?module=hms_yearlyMaintenance&_spAction=deleteValuelist&showHTML=0&valuelist_id=' + selectedId;
            $.get(url, function(){
                Util.hideProgressInd();
                cpm.hms.yearlyMaintenance.refreshCategoryOptions(valuelist_name);
            });
        });
                ...
                var expObj = {
                   ...
                   ,callbackOnSuccess: function(){
                        ...
                        Util.alert(msg, function(){
                            Util.closeAllDialogs();
                            cpm.hms.yearlyMaintenance.reloadParameters(medical_test_id);
        ...
        $('.deleteMedicalParameters').live('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                var url = 'index.php?module=hms_yearlyMaintenance&_spAction=DeleteMedicalParameters&showHTML=0&medical_test_parameter_id=' + medical_test_parameter_id;
        ...
        $('#AddMedicalTestGroup').live('click', function (e){
            ...
            var expObj = {
               ...
               ,callbackOnSuccess: function(){
                    ...
                    Util.alert(msg, function(){
                        Util.closeAllDialogs();
                        cpm.hms.yearlyMaintenance.reloadMedicalTestGroup(medical_test_id);
                        //window.location.reload(true);
                    });
                }
            }
        ...
        $('.deleteMedicalTestGroup').live('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                var url = 'index.php?module=hms_yearlyMaintenance&_spAction=DeleteMedicalTestGroup&showHTML=0&medical_test_group_id=' + medical_test_group_id;
    ...
    refreshValueListOptions: function(valuelistName, fieldName, selectedValue){
        var url = 'index.php?module=hms_yearlyMaintenance&_spAction=valueByValuelistJSON&showHTML=0';
    ...
    reloadParameters: function(medical_test_id){
        var url = 'index.php?module=hms_yearlyMaintenance&_spAction=medicalTestParameter&showHTML=0';
    ...
    reloadMedicalTestGroup: function(medical_test_id){
        var url = 'index.php?module=hms_yearlyMaintenance&_spAction=medicalTestGroupLink&showHTML=0';
        $.get(url,{medical_test_id:medical_test_id}, function(html){
