<?
class CPL_Admin_Modules_Hms_PatientVisit_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    function getdeletehistory() {
        return $this->model->getdeletehistory();
    }
    function getNotReceivedRecordUpdate() {
        return $this->model->getNotReceivedRecordUpdate();
    }
    function getReceivedRecordUpdate() {
        return $this->model->getReceivedRecordUpdate();
    }
    function getEditequipmenthistory() {
        return $this->view->getEditequipmenthistory();
    }
     function getEditequipmenthistorySubmit() {
        return $this->model->getEditequipmenthistorySubmit();
    }
    ...
    function getMedicalTestRecordUpdate() {
        return $this->model->getMedicalTestRecordUpdate();
    }

    function getMedicalTestRecordPrintUpdate() {
        return $this->model->getMedicalTestRecordPrintUpdate();
    }
    ...
    function getSelectDoctorForAppointment(){
        return $this->view->getSelectDoctorForAppointment();
    }
    ...
    function getInPatientSummary() {
        return $this->view->getInPatientSummary();
    }
    ...
    function getPrintolForm() {
        return $this->view->getPrintolForm();
    }
    ...
    function getCreateAdmission() {
        return $this->model->getCreateAdmission();
    }

    function getPatVisitRecWithInvCancelled() {
        return $this->view->getPatVisitRecWithInvCancelled();
    }

    function getUpdateConsultingFeesLink() {
        return $this->model->getUpdateConsultingFeesLink();
    }
    ...
    function getUpdateEmployeeIdOnAttendance() {
        return $this->model->getUpdateEmployeeIdOnAttendance();
    }

    function getVaccinationPortalDetailDisplay() {
        return $this->view->getVaccinationPortalDetailDisplay();
    }

    function getVaccinationRecordSubmit() {
        return $this->model->getVaccinationRecordSubmit();
    }

    function getVaccinationRecordDelete() {
        return $this->model->getVaccinationRecordDelete();
    }

    function getUpdateVaccinationFeesAndDate() {
        return $this->model->getUpdateVaccinationFeesAndDate();
    }

    function getVaccinationOutsideRecordSubmit() {
        return $this->model->getVaccinationOutsideRecordSubmit();
    }

    function getSummaryVaccination() {
        return $this->view->getSummaryVaccination();
    }

    function getVaccinationSchedule() {
        return $this->view->getVaccinationSchedule();
    }
    ...
    function getInvestigationsCategorySortOrderUpdate() {
        return $this->model->getInvestigationsCategorySortOrderUpdate();
    }

    function getUpdateTown() {
        return $this->view->getUpdateTown();
    }

    function getUpdateTownSubmit() {
        return $this->model->getUpdateTownSubmit();
    }

    function getUpdateTownFormValidate() {
        return $this->model->getUpdateTownFormValidate();
    }
    
    function getCancelAllInvoicesAndReceipts() {
        return $this->model->getCancelAllInvoicesAndReceipts();
    }

    function getViewNotesSummary() {
        return $this->view->getViewNotesSummary();
    } 

    function getUpdateTownInSession() {
        return $this->model->getUpdateTownInSession();
    }

    function getResetTownInSession() {
        return $this->model->getResetTownInSession();
    }

    function getReportReceivedFldFunction() {
        return $this->view->getReportReceivedFldFunction();
    } 

    function getAppointmentPortalDisplay() {
        return $this->view->getAppointmentPortalDisplay();
    } 

    function getAddAppointmentRecord() {
        return $this->view->getAddAppointmentRecord();
    } 

    function getAddAppointmentRecordSubmit() {
        return $this->model->getAddAppointmentRecordSubmit();
    }

    function getDeleteAppointmentRecord() {
        return $this->model->getDeleteAppointmentRecord();
    }

    function getAppointmentsList() {
        return $this->view->getAppointmentsList();
    } 

    function getUpdateAppointmentRecords() {
        return $this->model->getUpdateAppointmentRecords();
    }
}