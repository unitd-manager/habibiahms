...
class CPL_Admin_Modules_Hms_Reports_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    function getReferenceDoctorAppointmentReportExport() {
      ...
      function getRackWiseReport() {
        $wRackWiseReport = getCPWidgetObj('hms_rackWiseReport');
        return $wRackWiseReport->getWidget();
    }

    function getRackWiseReportExport() {
        $wRackWiseReport = getCPWidgetObj('hms_rackWiseReport');
        return $wRackWiseReport->model->getExportToExcel();
    }
    ...
    function getDiabetesReport() {
        $wDiabetesReport = getCPWidgetObj('hms_diabetesReport');
        return $wDiabetesReport->getWidget();
    }

    function getDiabetesReportExport() {
        $wDiabetesReport = getCPWidgetObj('hms_diabetesReport');
        return $wDiabetesReport->model->getExportToExcel();
    }
