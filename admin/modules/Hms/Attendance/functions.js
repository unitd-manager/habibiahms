...
cpm.hms.attendance.init = function(){
    ...
    // Add delete button click handler for both list and modal views
    $('.deleteAttendance').livequery('click', function(e) {
        e.preventDefault();
        var daily_attendance_id = $(this).attr('daily_attendance_id');
        
    
        var url = 'index.php?module=hms_attendance&_spAction=DeleteEmployeSubmit&showHTML=0';
        $.get(url, {daily_attendance_id: daily_attendance_id}, function(html) {
            Util.hideProgressInd();
