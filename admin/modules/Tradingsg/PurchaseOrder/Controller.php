...
class CPL_Admin_Modules_Tradingsg_PurchaseOrder_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    function getUpdateOverallDiscount() {
        return $this->model->getUpdateOverallDiscount();
    }

    function getViewMedicines() {
        return $this->view->getViewMedicines();
    }

    function getCheckSoldQtyInBatchWiseStock() {
        return $this->model->getCheckSoldQtyInBatchWiseStock();
    }

    function getReturnQtyProductStock() {
        return $this->view->getReturnQtyProductStock();
    }

    function getReturnQtyProductNoStock() {
        return $this->view->getReturnQtyProductNoStock();
    }

    function getReturnQtyPoProductSubmit() {
        return $this->model->getReturnQtyPoProductSubmit();
    }

    function getReturnQtyPoProductNSSubmit() {
        return $this->model->getReturnQtyPoProductNSSubmit();
    }

    function getViewAllQtyDetails() {
        return $this->view->getViewAllQtyDetails();
    }

    function getUpdatePurchaseReturn() {
        return $this->model->getUpdatePurchaseReturn();
    }

    function getCheckPricePercentage() {
        return $this->model->getCheckPricePercentage();
    }
}