...
cpm.hms.reports = {
    init: function(){
        ...
        $('.w-hms-balanceSheetReport .expenseDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsHead');
            $('.subTitles', parent).slideToggle();
        }); 

        $('.w-hms-balanceSheetLabReport .expenseDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsHead');
            $('.subTitles', parent).slideToggle();
        }); 

        $('.w-hms-balanceSheetImageReport .expenseDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsHead');
            $('.subTitles', parent).slideToggle();
        }); 

        $('.w-hms-balanceSheetPharmacyReport .expenseDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsHead');
            $('.subTitles', parent).slideToggle();
        }); 

        $('.w-hms-balanceSheetReport .expenseSubHeadDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsSubHead');
            $('.subTitlesWithoutGroup', parent).slideToggle();
        });

        $('.w-hms-balanceSheetLabReport .expenseSubHeadDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsSubHead');
            $('.subTitlesWithoutGroup', parent).slideToggle();
        }); 

        $('.w-hms-balanceSheetImageReport .expenseSubHeadDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsSubHead');
            $('.subTitlesWithoutGroup', parent).slideToggle();
        }); 


        $('.w-hms-balanceSheetPharmacyReport .expenseSubHeadDetails').livequery('click', function(){
            var parent = $(this).closest('.expenseDetailsSubHead');
            $('.subTitlesWithoutGroup', parent).slideToggle();
        });

        /*$('.w-hms-balanceSheetReport .InPatientAmountDetails').livequery('click', function(){
            var parent = $(this).closest('.InPatientAmountDetailsHead');
            $('.InPatientAmount', parent).slideToggle();
        }); */
        ...
        $('.expenseRecDetailsToggle').livequery('click', function(){
            var parent = $(this).closest('.detailSummaryByClientPaymentDetails');
            $('.expenseRecDetails', parent).slideToggle();
        });
    },
