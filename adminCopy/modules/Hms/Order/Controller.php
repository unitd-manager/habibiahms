<?
class CPL_Admin_Modules_Hms_Order_Controller extends CP_Admin_Modules_Hms_Order_Controller
{
    /**
     *
     */
    ...
    function getUpdateInpatCodeOnOrder(){
        return $this->model->getUpdateInpatCodeOnOrder();
    }

    function getUpdateVisitCodeOnOrder(){
        return $this->model->getUpdateVisitCodeOnOrder();
    }

    function getsearchinPatientCode() {
        return $this->model->getsearchinPatientCode();
    }

    function getSearchPatientVisitCode() {
        return $this->model->getSearchPatientVisitCode();
    }

    function getEditcode(){
        return $this->view->getEditcode();
    }

    function getEditVisitcode(){
        return $this->view->getEditVisitcode();
    }
    ...
    function getGenerateInvoiceFormSubmitavv() {
        $modObj = getCPModuleObj('hms_invoice');
        return $modObj->model->getGenerateInvoiceFormSubmitavv();
    }
    ...
    function getGenerateInvoiceCode() {
        return $this->view->getGenerateInvoiceCode();
    }
    function getGenerateReceiptCode() {
        return $this->view->getGenerateReceiptCode();
    }
    function getUpdateInvoiceCodeNumber() {
        return $this->view->getUpdateInvoiceCodeNumber();
    }
    function getUpdateReceiptCodeNumber() {
        return $this->view->getUpdateReceiptCodeNumber();
    }

    function getPrescriptionRegister() {
        return $this->view->getPrescriptionRegister();
    }

    function getSelectSession() {
        return $this->view->getSelectSession();
    }

    function getCancelBill() {
        return $this->model->getCancelBill();
    }

    function getPrintInvoiceForIPRecord() {
        return $this->view->getPrintInvoiceForIPRecord();
    }

    function getPrintReceiptForIP() {
        return $this->view->getPrintReceiptForIP();
    }
}