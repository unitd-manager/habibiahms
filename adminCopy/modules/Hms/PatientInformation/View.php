                    ...
                    <table class='thinlist'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{$formObj->getTBRow('Age Years', 'age_year', $row['age_year'])}</td>
                                <td>{$formObj->getTBRow('Age Months', 'age_month', $row['age_month'])}</td>
                                <td>{$formObj->getTBRow('Age Days', 'age_day', $row['age_day'])}</td>
                            </tr>
                            <tr>
                                ...
                                <td>{$formObj->getTBRow('Town/City', 'address_area', $row['address_area'])}</td>
                            </tr>
                            <tr>
                                <td>{$formObj->getTARow('Remarks', 'remarks', $row['remarks'])}</td>
                                <td>{$formObj->getTARow('Previous Medical History', 'previous_medical_history', $row['previous_medical_history'])}</td>
                                <td>{$formObj->getYesNoRRow('Blacklist', 'blacklist', $row['blacklist'])}</td>
                                <td>{$formObj->getYesNoRRow('Diabetes', 'diabetes', $row['diabetes'])}</td>
                            </tr>
    ...
    function getQuickSearch() {
        ...
        <td>
            <select name='blacklist'>
                {$cpUtil->getDropDown1($blackListArray, $blacklist)}
           </select>
        </td>
        ";
