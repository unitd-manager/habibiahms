...
cpm.hms.labTest = {
    init: function(){
        ...
        $('.m-hms_labTest .otherLabs').livequery('click', function (e){
            ...
            if(is_checked == true){
                var update = 1;
                var url = 'index.php?module=hms_labTest&_spAction=medicalTestRecordUpdate&showHTML=0';
                Util.showProgressInd();
                $.get(url, {lab_test_id:lab_test_id, container:container,  lab_supplier_fees:lab_supplier_fees, supplier_id:supplier_id, medical_test_id:medical_test_id, update:update}, function(html){
                    Util.hideProgressInd();
                    $('.hideLabSupplierFees', parent).show();
                    cpm.hms.labTest.reloadReportReceived(0);
                });
            } else {
                var update = 0;
                ...
                $.get(url, {lab_test_id: lab_test_id, container:container, lab_supplier_fees:lab_supplier_fees, supplier_id:supplier_id, medical_test_id:medical_test_id, update:update}, function(html){
                    ...
                    cpm.hms.labTest.reloadReportReceived(1);
                });
            }
        });
    ...
    reloadReportReceived: function(update){
        var url = 'index.php?module=hms_labTest&_spAction=reportReceivedFldFunction&showHTML=0';
